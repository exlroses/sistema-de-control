          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <h2 class="box-title">Venta <button class="btn btn-success" id="btnAgregar" onclick="mostrarform(true)">
...
<div class="panel-body" style="height: 400px;" id="formularioregistro">
                                <form name="formaulario" id="formaulario" method="post">
                                    <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <select name="idcliente" id="idcliente" class="form-control" data-live-search="true" required>
